...
itemStyle: {
  normal: {
	color: function(params) {
	  return params.name == $scope.device.unit.name ? '#f9d74e' : '#ff3939'
	}
  }
},
...
### 饼图 Pie
```js
$scope.deviceBrand = [{"name":"大华NVR通道","value":2059},{"name":"大华NVR","value":780},{"name":"海康解码器电视墙（DS-65XX-B20）","value":1000}];
var pieOption = {
  tooltip: {
	  trigger: 'item',
