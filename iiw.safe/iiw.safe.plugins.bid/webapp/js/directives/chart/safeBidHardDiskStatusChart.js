...
define([
    ...
    app.directive('safeBidHardDiskStatusChart', ['$interval', '$filter', 'iTimeNow', 'iAjax', function($interval, $filter, iTimeNow, iAjax) {
        return {
            restrict: 'AE',
            replace: true,
            scope: true,
            link: function($scope, $element) {
                var childEle = $element.find('.safe-bid-hard-disk-status-chart-panel').get(0);
