...
define([
    ...
    app.directive('safeBidDataSheJiaoGaugeChart', [function() {
        return {
            restrict: 'AE',
            replace: true,
            scope: true,
            link: function($scope, $element) {
                var childEle = $element.find('.safe-bid-data-she-jiao-gauge-chart-panel').get(0);
