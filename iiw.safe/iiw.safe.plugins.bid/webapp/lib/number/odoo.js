!function (t, e) {
    ...
    return function (t) {
        ...
        e["default"] = function (t) {
            var e, r = t.el, a = t.value, n = t.lineHeight, i = void 0 === n ? 1.35 : n, g = t.letterSpacing,
                m = void 0 === g ? 1 : g, b = t.animationDelay, _ = void 0 === b ? 100 : b, x = t.letterAnimationDelay,
                j = void 0 === x ? 100 : x, M = (0, o.select)(r), P = window.getComputedStyle(M),
                O = parseInt(P.fontSize, 10), w = (O * i - O) / 2 + O / 10, S = O * i - w, D = 0, E = O * i + w;
            M.innerHTML = "";
            var F = o.append.call(M, "svg"), k = (e = o.append.call(F, "svg"), o.attr).call(e, "mask", "url(#mask)"),
                A = o.append.call(F, "defs");
            v(A), y(A);
            var B = String(a).replace(/ /g, " ").split(""), N = B.map(function (t, e) {
                return isNaN(parseInt(t, 10)) ? {
                    isDigit: !1,
                    node: s(k, t, O),
                    value: t,
                    offset: {x: 0, y: S}
                } : {isDigit: !0, id: e, node: d(k, O, i, e), filter: p(A, e), value: Number(t), offset: {x: 0, y: S}}
        ...
        e["default"] = function (t) {
            var e = t.from, a = t.to, n = t.duration, l = void 0 === n ? 3e3 : n, o = t.delay, i = void 0 === o ? 0 : o,
                u = t.easing, c = void 0 === u ? r : u, f = t.start, d = void 0 === f ? function (t) {
                    return t
