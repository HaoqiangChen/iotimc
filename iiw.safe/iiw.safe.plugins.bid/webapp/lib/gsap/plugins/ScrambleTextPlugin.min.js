...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    var a = function (b) {
            ...
            this.chars = g(a), this.sets = [], this.length = 50;
            var c;
        ...
        }, d = "[-]|�[�-�]|�[�-�]|[⚔-⚗]|�[�-�]|[�-�][�-�]", e = new RegExp(d), f = new RegExp(d + "|.", "g"),
        g = function (a, b) {
            return "" !== b && b || !e.test(a) ? a.split(b || "") : a.match(f)
        }, h = "ABCDEFGHIJKLMNOPQRSTUVWXYZ", i = h.toLowerCase(),
        j = {upperCase: new c(h), lowerCase: new c(i), upperAndLowerCase: new c(h + i)}, k = _gsScope._gsDefine.plugin({
            propName: "scrambleText",
            version: "0.5.1",
            API: 2,
            overwriteProps: ["scrambleText", "text"],
            init: function (b, d, f, h) {
                if (this._prop = "innerHTML" in b ? "innerHTML" : "textContent" in b ? "textContent" : 0, !this._prop)return !1;
                "function" == typeof d && (d = d(h, b)), this._target = b, "object" != typeof d && (d = {text: d});
                var i, k, l, m;
