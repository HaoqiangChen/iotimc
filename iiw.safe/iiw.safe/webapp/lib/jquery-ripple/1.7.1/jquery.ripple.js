...
(function($, ua) {
    ...
    $.fn.ripple = function(options) {
        ...
        opts.event = 'touchstart.ripple mousedown.ripple';
        opts.end_event = 'touchend.ripple touchcancel.ripple mouseup.ripple mouseleave.ripple';
        ...
        $(this)
            ...
            .on(opts.event, function(ev) {
                var x, y, touch_ev,
                    $paper = $(this),
                    $ink = $('<div/>'),
                    size = Math.min($paper.width(), $paper.height());
                ...
                touch_ev = ev.originalEvent.touches ? ev.originalEvent.touches[0] : ev;
