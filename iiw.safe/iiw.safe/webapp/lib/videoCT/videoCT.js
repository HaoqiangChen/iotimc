...
$.fn.videoCt = function (options) {
    ...
    var getVideoInf = function (){
        var setTimer;
        var key = true;
        if ($videoCt.length && $videoCt[0].readyState != null && $videoCt[0].readyState != 4 && $('.video-seek video').length && $('.video-seek video')[0].readyState != 4) {
            ...
            var vPlay = function() {
                if(!intOpts.status) {
                    ...
                    seTimer = setInterval(function () {
                        ...
                        if(intOpts.cutover && $videoCt[0] && $videoCt[0].buffered && $videoCt[0].duration){
