...
define(['app'], function(app) {
    var input = '<div class="input-search">' +
        ...
        '<input type="text" class="form-control" ng-keydown="init($event)" ng-model="severe.filter" placeholder="请输入搜索内容" i-dom-select="">' +
        '</div>' +
        '<button ng-click="init()" class="search-button">' +
